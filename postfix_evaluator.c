...
//Main heart of the code "Evaluating the Postfix expression" and returns the result
double evaluatePostfix(char* postfixExpression,struct stack* s){
    int i=0;
...
int main(){
    ...
    */
    ...
    printf("The result of the postfix expression: %0.3f",evaluatePostfix(postfix_expression,&s));
    return 0;
}